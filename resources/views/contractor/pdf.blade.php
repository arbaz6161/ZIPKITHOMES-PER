            ...
            <tr>
                <td style="width:40%;">
                    <div style="height:200px">
                        <img src="{{ url($floorplan->images[0]['pic_url']) }}" alt="{{ $floorplan->images[0]['pic_name'] }}" style="width:auto;height:auto;object-fit:cover;max-width:100%;max-height:100%;">
                        <p style="margin-top:10px">{{ $floorplan->pivot->is_keep_same_name == 1 ? $floorplan->plan_name : $floorplan->pivot->floor_plan_rename }}</p>
                    </div>
                </td>
		            <td style="width:20%;"></td>		
                <td style="width:40%; line-height:30px; margin-top:20px;">
                    <p>{{ $values['name'] }}</p>
                    <p>{{ $values['email'] }}</p>
                    <p>{{ $values['phone'] }}</p>
                ...
                <tr>
                    <td style="width:25%;">
                        <div style="height:100px">
                            <img src="{{ url($product->images[0]['pic_url']) }}" alt="{{ $product->images[0]['pic_name'] }}" style="width:auto;height:auto;object-fit:cover;max-width:100%;max-height:100%;">
                        </div>
                    </td>
