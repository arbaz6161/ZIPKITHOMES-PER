...
<div class="container">
    ...
    <div class="row">
                    ...
                    <form action="{{ route('contractor.email.store', ['subdomain' => $subdomain]) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                id="phone"
                                name="phone"
                                class="form-control form-control-solid @error('phone') is-invalid @enderror w-50"
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="home_location" style="color: black;">Home Location :</label>
                                    <input
                                        type="text"
                                        id="home_location"
                                        name="home_location"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select
                                        name="home_state"
                                        id="state"
                                        class="form-control form-control-solid custom-select @error('home_state') is-invalid @enderror"
                                        style="color: black; border-color: black;"
                                    >
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="zip" style="color: black;">Zip Code :</label>
                                    <input
                                        type="text"
                                        id="zip"
                                        name="home_zip"
                                        class="form-control form-control-solid @error('home_zip') is-invalid @enderror"
        ...
        <div class="col-md-4 pl-10">
            ...
            {!! $floorplan->plan_additional_text !!}
            <hr>
