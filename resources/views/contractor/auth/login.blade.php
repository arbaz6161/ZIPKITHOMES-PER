...
@section('title', 'Myplanbase - HomeBuyer Login Credentials Required')
...
<div class="main-container">
    <div class="container-login">
        <div class="wrap-login">
            ...
            <form method="post" action="{{ route('contractor.login', ['subdomain' => $subdomain]) }}" class="login-form validate-form">
                @csrf
                ...
                <div class="col-md-12 text-center pt-2">
                    If you don't have an account, register <a href="{{ route('contractor.register', ['subdomain' => $subdomain]) }}">here</a>.
                </div>
