                ...
                <tr>
                    ...
                    <td style="width: 40%;">
                        <div style="text-align:center;height:200px">
                            <img src="{{ url($floorplan->images[0]['pic_url']) }}" alt="{{ url($floorplan->images[0]['pic_name']) }}" style="width:auto;height:auto;object-fit:cover;max-width:100%;max-height:100%;">
                        </div>
                    </td>
                </tr>
            </tbody>
                ...
                <tr>
                    <td style="width:25%;">
                        <div style="text-align:center;height:100px">
                            <img src="{{ url($product->images[0]['pic_url']) }}" alt="{{ url($product->images[0]['pic_name']) }}" style="width:auto;height:auto;object-fit:cover;max-width:100%;max-height:100%;">
                        </div>
                    </td>
