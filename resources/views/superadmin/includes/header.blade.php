        ...
        <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
            <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                ...
                <ul class="menu-nav" role="tablist">
                    ...
                    <li class="menu-item mb-3 {{ request()->route()->getName()=='super.customers.index' ? 'active': '' }}" title="Customers">
                        <a href="{{ route('super.customers.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <polygon points="0 0 24 0 24 24 0 24" />
                    ...
                    <li class="menu-item mb-3 {{ request()->route()->getName()=='super.categories.index' ? 'active': '' }}" title="Floor Plan Categories">
                        <a href="{{ route('super.categories.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="menu-text">Floor Plan Categories</span>
                        </a>
                    </li>

                    <li class="menu-item mb-3 {{ request()->route()->getName()=='super.categorymapping.index' ? 'active': '' }}" title="Category Mappings">
                        <a href="{{ route('super.categorymapping.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="menu-text">Category Mappings</span>
                        </a>
                    </li>
                </ul>
                <!--end::Nav-->
