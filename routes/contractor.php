...
Route::group(["middleware" => "checkContractor"], function () {
    ...
    Route::post('floorplans/{floorplan}/contact', "FloorPlanController@contact_submit")->name('contact.submit');
    ...
    Route::post('floorplans/{floorplan}/items/update', "ProductGroupController@update_item")->name('items.update');
    ...
    Route::get('floorplans/{floorplan}/project/create', 'ProjectController@create')->name('project.create');
    Route::post('floorplans/{floorplan}/project/store', 'ProjectController@store')->name('project.store');
    ...
    Route::get('floorplans/{floorplan}/cart/create', 'ExportController@create_cart')->name('cart.create');
    ...
    Route::group(['prefix' => 'admin', 'middleware' => 'customauth', 'namespace' => 'Admin'], function () {
        ...
        Route::post('floorplans/get_data', "FloorPlanController@getData")->name("admin.floorplans.get_data");
